...
% xyDet=SM_psf_GibsonLanni_584nm_NA14(~,xyzEm,opt)
%
...
% settings for the Gibson-Lanni PSF model [4], 584 nm, and NA=1.4, and 5 nm
...
%             the PSF model.
%
% Parameterize you own: numericalPSF_GibsonLanni_584nm_NA14.mat has fields
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SM_psf_GibsonLanni_584nm_NA14, PSF-simulator in the SMeagol package
% ========================================================================= 
...
%% actual code
function xyDet=SM_psf_GibsonLanni_584nm_NA14(~,xyzEm,~)
...
if(size(xyzEm,1)>0)
    ...
    if(~isempty(indW))
        warning('SM_psf_GibsonLanni_584nm_NA14: input z out of range')
    end
