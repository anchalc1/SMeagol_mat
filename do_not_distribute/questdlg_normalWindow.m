function ButtonName=questdlg_normalWindow(Question,Title,Btn1,Btn2,Btn3,Default)
%QUESTDLG Question dialog box.
%
% Modified version that allows the user to interact with other windows
% before responding, by changing the 'windowstyle' to 'normal'.
% 
% ----- original help text ------------------------------------------------
%
...
warning('This function needs to be rewritten, as it is probably (C) Mathworks!')
