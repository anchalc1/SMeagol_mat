...
% detected.
psf.type='SM_psf_psfStack_pxInterp';
psf.dz=50;
psf.dxy=44;
psf.xyzFocal=[ 52.687 50.954 31];

psf.psfTifFile=fullfile(pwd,'psfModel_single_spot_from_Z-stack_2_dxy44nm_dz50nm_focalPlane31_xF52.687_yF50.954.tif');
